/*
	File Name: fn_ems_aux_lights_master.sqf
	File Created: 5/8/2014
	File Version: 1.0
	File Author: @Foamy / @Waldron 
	File Last Edit Date: 5/28/2014
	File Description: EMS Aux (Front Bumper) Lights Master Script	
*/
...
if (isNil "_vehicle" || isNull _vehicle || !(_vehicle getVariable "ems_lights_aux")) exitWith {};
...
{ 
	if (!(_vehicle getVariable "ems_lights_aux")) exitWith {};
	if (_leftBlue) then 
	{  
		_leftBlue = false;  
