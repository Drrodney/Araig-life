...
player createDiarySubject ["special","Special Licenses"];
...
*/
	...
	player createDiaryRecord["changelog",
		[
			"Custom Change Log",
				"
					Added: A swaggin ass status bar.
					Fixed: Markets, use item, briefing. Also personal sobriety.
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"City Protocol", 
				...
				6. The Police HQ buildings, and areas are illegal for civilians to enter without authorization, however it is NOT illegal for civilians to be nearby unless they are causing a nuisance.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["controls",
		[
			"",
				...
				L Key (Light System - Shift+L = Main Lights, Crtl+L = Aux Lights, Ctrl+Shift+L = Strobes, Alt+L = Hazard Lights)<br/>
				Q Key (Left Turn Signal) / E Key (Right Turn Signal)<br/>
				O key - Open / Close cop gate<br/>
...
// Licenses Section
	...
	player createDiaryRecord ["special",
		[
			"Federal Firearms License",
				"
				 A civilian may open carry a weapon on the following list only, outside of city limits<br/><br/>
				 If caught open carrying within city limits, it is police discretion whether or not to remove the weapon and/or FFL from the owner.<br/><br/>
				 Under no circumstances is the ownership, use, or possession of explosives, and explosive accessories legal.<br/><br/>
				 1. MX Series<br/>
				 2. Katiba Series<br/>
				 3. TRG Series<br/>
				 4. Mk.20 Series<br/>
	...
	player createDiaryRecord ["special",
		[
			"Bounty Hunting laws",
				"
				Bounty Hunters:<br/><br/>
				1. Bounty Hunters will follow all laws regarding Firearms licenses, and Federal firearms Licenses.<br/>
				2. Bounty Hunters must work with Law Enforcement Officials at all times, when asked, or when chasing a bounty.<br/>
				3. Bounty Hunters are not required to assist the Police in any activities, and vice versa, however the bounty hunter will still keep the LEO's apprised of his BH actions.<br/>
				4. Upon restraining a bounty, the Hunter is required to take him to Kavala HQ for turn in, wait outside the gate. He will turn the bounty over to the LEO's and receive a fitting compensation.<br/><br/>
				"
		]			
	];
	...
	player createDiaryRecord ["special",
		[
			"Lawyering Rules",
				"
				Lawyers:<br/><br/>
				1. When a civilian obtains a license for lawyering he has the ability to force a trial, for a suspected criminal.<br/>
				2. If a criminal has made it to the wanted list, a lawyer must prove his clients innocence to an appointed judge.<br/>
				3. The claim 'I want a lawyer', is a valid claim, and will be fufilled, if a valid lawyer is online and wants the case.<br/>
				4. A lawyer may set his price, as he sees fit. As also he may take the cases as he sees fit.<br/>
				5. If no lawyer is online, the case is resolved at the judges discretion.<br/><br/>
				"
		]
	];
