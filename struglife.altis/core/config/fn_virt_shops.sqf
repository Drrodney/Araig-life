...
switch (_shop) do
{
	...
	case "fishmarket": {["Altis Fish Market",["salema","ornate","mackerel","mullet","tuna","catshark","cornmeal"]]};
	...
	case "bar": {["Altaisia",["bottledbeer","bottledwhiskey"]]};
	case "speakeasy": {["Bartender",["bottledwhiskey","bottledshine","bottledbeer","moonshine"]]};
