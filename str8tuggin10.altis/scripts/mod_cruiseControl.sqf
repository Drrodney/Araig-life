...
uwg_cruise_control = uwg_cruise addAction ['Cruise Control','["""""""",call mod_cruiseControlMenu,player,false] spawn BIS_fnc_MP;',[], 0, false, false, '', 'driver uwg_cruise == player'];"",
